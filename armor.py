...
armor_all = [[Armor("кепка", 1, 0, life=100, max_life=100),
              ...
              Armor("☯️мифический шлем", 50, 0, life=700, max_life=700, type_stack=4, cost=150000),
             ...
             # +150 силы +100 ловкости + 150 удачи
              Armor("☣️шлем тиранид", 140, 0, life=2500, type_stack=7, max_life=2500)],
             ...
             [Armor("плащ", 1, 1, life=100, max_life=100),
              ...
              Armor("☯️мифическая броня", 90, 1, life=1300, type_stack=4, max_life=1300, cost=150000),
              ...
              Armor("☣️броня тиранид", 220, 1, life=3500, type_stack=7, max_life=3500)],
             ...
             [Armor("руковицы", 1, 2, life=100, max_life=100),
              ...
              Armor("👹даэдрические перчатки", 40, 2, life=600, type_stack=3, max_life=600, cost=90000),
