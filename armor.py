...
armor_all = [[Armor("кепка", 1, 0, life=100, max_life=100),
              ...
              Armor("👺️шлем Шао-Кана", 150, 0, life=1500, type_stack=10, max_life=1500, cost=150000)],
             [Armor("плащ", 1, 1, life=100, max_life=100),
              ...
              Armor("👺доспех Шао-Кана", 230, 1, life=500, type_stack=10, max_life=500),
              ],
             ...
             [Armor("рукавицы", 1, 2, life=100, max_life=100),
              ...
              Armor("☣️️перчатки тиранид", 130, 2, life=1500, type_stack=7, max_life=1500, cost=130000),
              ...
              Armor("👺перчатки Шао-Кана", 140, 2, life=500, type_stack=10, max_life=500),
              ]]
