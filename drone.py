...
all_drones = [Drone(1, 100, "малыш", 10, 10, 200000, [0, 0, 0, 10], 15),
              Drone(2, 150, "рад-дрон", 20, 15, 500000, [0, 20, 0, 10], 20),
              Drone(3, 250, "крепыш", 40, 20, 1000000, [0, 20, 40, 40], 25),
              Drone(4, 400, "арена-дрон", 70, 25, 1500000, [0, 40, 40, 40], 30),
              Drone(5, 500, "дино-дрон", 80, 25, 1500000, [0, 40, 40, 40], 30),
              Drone(6, 600, "монолит", 90, 30, 1500000, [0, 40, 40, 40], 40)]
